        ...
        <React.Fragment>
            ...
            <Container className="about-us">
                ...
                <Container className='about-us-part'>
                    <img src={image1} className='about-us-image'/>
                    <div>
                        <h2>Who We Are</h2>
                ...
                <Container className='about-us-part'>
                    ...
                    <img src={image2} className='about-us-image'/>
                </Container>
                <h2>Our Philosophy</h2>
                <Container className='about-us-part'>
                    <img src={image3} className='about-us-image'/>
                    <div>
                ...
                <Container className='about-us-part'>
                    ...
                    <img src={image4} className='about-us-image'/>
                </Container>
                <Container  className='about-us-part'>
                    <img src={image5} className='about-us-image'/>
                    <div>
